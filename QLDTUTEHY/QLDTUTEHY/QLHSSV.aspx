<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="QLHSSV.aspx.cs" Inherits="QLDTUTEHY.QLHSSV" %>
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Quản lý Học Sinh Sinh Viên</h3>
            </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div class="x_content">
                                ...
                                <asp:GridView ID="grvHSSV" runat="server" OnPageIndexChanging="grvHSSV_PageIndexChanging" HeaderStyle-CssClass="heading" AllowPaging="True" PageSize="10" DataKeyNames="MaHSSV"
                                    CssClass="table table-striped responsive-utilities jambo_table bulk_action col-lg-12 col-md-12 col-xs-12 col-sm-12"
                                    AutoGenerateColumns="False" OnRowCommand="grvHSSV_RowCommand" HeaderStyle-BackColor="#ffffcc" HeaderStyle-VerticalAlign="Middle" HeaderStyle-HorizontalAlign="Center">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MaHSSV" HeaderText="Mã HSSV" />
                                       ...
                                       <asp:TemplateField HeaderText="Ngày Sinh">
                                        ...
                                        <asp:BoundField DataField="NoiOHienNay" HeaderText="Nơi ở hiện nay" />
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Học Sinh Sinh Viên</h4>
                                            </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group" id="divMa">
                                                    ...
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                                                        Mã HSSV:<span class="required">*</span>

                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <asp:TextBox runat="server" ID="txtMaHSSV" CssClass="form-control col-md-7 col-xs-12" required="required" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <asp:TextBox runat="server" ID="txtHoTen" CssClass="form-control col-md-7 col-xs-12" required="required" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                                               ...
                                               <%-- <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <asp:TextBox runat="server" ID="txtNoiSinh" CssClass="form-control col-md-7 col-xs-12" required="required"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                                                        Quê Quán:<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <asp:TextBox runat="server" ID="txtQueQuan" CssClass="form-control col-md-7 col-xs-12" required="required" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                                                        Nơi Ở Hiện Nay:<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <asp:TextBox runat="server" ID="txtNoiOHienNay" CssClass="form-control col-md-7 col-xs-12" required="required"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
    ...
    <script>
        ...
        function CheckValidate() {
            $('#btnThem').click(function () {
                ...
                $("#<%=txtMaHSSV.ClientID%>").removeAttr('disabled');
            ...
            $('#<%=txtMaHSSV.ClientID%>').change(function () {
                var id = $('#<%=txtMaHSSV.ClientID%>').val();
                $.ajax({
                    type: "POST",
                    url: "SV/CheckID.asmx/CheckIDHSSV",
                    data: "{'id':'" + id + "'}",
            ...
            $('#modalEdit').on('hidden.bs.modal', function () {
                ...
                function CheckFalse() {
                    var inputma = $('#<%=txtMaHSSV.ClientID%>').parsley();
                    window.ParsleyUI.addError(inputma, 'myerror', 'Mã vừa nhập đã tồn tại hãy nhập mã khác');
